...
const InicioScreen = ({navigation}) => {
    ...
    return(
        <View style={screenStyles.container}>
            ...
            <Button onPress={() => { IrPagina('IniciarSesionScreen') }} style={screenStyles.buttonSpace}>Iniciar sesión</Button>
            <Button style={screenStyles.buttonSpace} imgSrc={require('../../assets/google-icon.png')}>Iniciar sesión con Google</Button>
            <Button onPress={() => { IrPagina('RegistrarUsuarioScreen') }}>Registrarse</Button>
        </View>
    )
